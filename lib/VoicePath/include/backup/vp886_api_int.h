 ...
 *
 * $Revision: 12594 $
 * $LastChangedDate: 2018-07-05 14:12:46 -0500 (Thu, 05 Jul 2018) $
 */
...
/* Time between masking the SW_SKIP interrupt and unmasking it to check again */
#define VP886_SWSKIP_CHECK_TIME 150

/* Time that must pass with no SW_SKIP interrupt (while unmasked) in order to
   clear the swskip status flag. */
#define VP886_SWSKIP_CLEAR_TIME 50

/* Minimum time between clearing and re-reading switcher ontime register for
   VP_QUERY_ID_SW_DUTY_CYCLE, in ms */
#define VP886_QUERY_SW_DUTY_CYCLE_TIME 7
...
/* Default DTMF rejection thresholds, which can be modified by the
   rejectionFactor param of VP_OPTION_ID_DTMF_PARAMS */
#define VP886_DTMF_REL_PEAK_ROW_FACTOR 63   /* 6.3, 8dB, divide result by 10 */
#define VP886_DTMF_REL_PEAK_COL_FACTOR 63   /* 6.3, 8dB, divide result by 10 */
#define VP886_DTMF_2ND_HARM_ROW_FACTOR 25   /* 2.5, 4dB, divide result by 10 */
#define VP886_DTMF_2ND_HARM_COL_FACTOR 631  /* 63.1, 18dB, divide result by 10 */
#define VP886_DTMF_TOTAL_ENERGY_VADC_FACTOR 370 /* 37.0, divide result by 10 */
#define VP886_DTMF_TOTAL_ENERGY_SADC_FACTOR 280 /* 28.0, divide result by 10 */
...
typedef enum {
    ...
    VP886_LINE_QUERY_TEMP       = 0x0100, /* VP_QUERY_ID_TEMPERATURE in progress */
