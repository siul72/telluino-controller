...
#if defined (VP_CC_MELT792_SERIES)
        case VP_DEV_MELT792_SERIES:
            status = Melt792MakeDeviceCtx(pDevCtx, pDevObj);
            break;
#endif
...
#if defined (VP_CC_MELT792_SERIES)
        case VP_DEV_MELT792_SERIES:
            channelId = ((VpMelt792LineObjectType *)pLineObj)->channelId;
            deviceId = ((VpMelt792DeviceObjectType *)pDevObj)->deviceId;
            break;
#endif
    ...
    VpLineIdType lineId)       /**< Value assigned as line Id */
{
    ...
    switch (devType) {
        ...
        case VP_DEV_MELT792_SERIES:
            deviceId = ((VpMelt792DeviceObjectType *)pDevObj)->deviceId;
            VpSysEnterCritical(deviceId, VP_CODE_CRITICAL_SEC);
            ((VpMelt792LineObjectType *)pLineObj)->lineId = lineId;
            VpSysExitCritical(deviceId, VP_CODE_CRITICAL_SEC);
            break;
#endif
