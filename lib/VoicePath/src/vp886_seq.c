        ...
        switch (instr) {
            ...
            case VP_CLI_SILENCE: {
                if (pCidObj->state == VP886_CID_ST_NEW_INSTR) {
                    ...
                    VP_CID(VpLineCtxType, pLineCtx, ("Delay %u", delayMs));
            ...
            case VP_CLI_SILENCE_MASKHOOK: {
                if (pCidObj->state == VP886_CID_ST_NEW_INSTR) {
                    ...
                    VP_CID(VpLineCtxType, pLineCtx, ("Delay %u, hook freeze %u", delayMs, hookMaskMs));
            ...
            case VP_CLI_DETECT: {
                ...
                if (pCidObj->state == VP886_CID_ST_NEW_INSTR) {
                    ...
                    VP_CID(VpLineCtxType, pLineCtx, ("Detect interval for 0x%02X and 0x%02X, timeout %u",
    ...
    uint8 type)
{
    ...
    if (pCidObj->state == VP886_CID_ST_NEW_INSTR) {
        ...
        pCidObj->markOrSeizureBytes = (uint16)VpRoundedDivide((uint32)duration * 12, 100);
    ...
    uint32 overrun)
{
    ...
    switch (pLineObj->howlerState) {
        ...
        case VP886_HOWLER_ST_AMP_STEPPING_UK_AUS: {
            ...
            pLineObj->howlerLevel = (uint16)tempLevel;
            sigCD[6] = (pLineObj->howlerLevel & 0xFF00) >> 8;
            sigCD[7] = (pLineObj->howlerLevel & 0x00FF);
