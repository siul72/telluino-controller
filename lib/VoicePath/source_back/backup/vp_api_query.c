    ...
    VpLineStateType *pCurrentState)
{
    ...
    switch (pDevCtx->deviceType) {
        ...
        case VP_DEV_MELT792_SERIES: {
            VpMelt792LineObjectType *pLineObj = pLineCtx->pLineObj;
    ...
    VpDeviceInfoType *pDeviceInfo)
{
    ...
    switch(devType) {
        ...
        case VP_DEV_MELT792_SERIES:
            pDeviceInfo->numLines =
                ((VpMelt792DeviceObjectType *)pDevObj)->maxChannels;
            pDeviceInfo->deviceId =
                ((VpMelt792DeviceObjectType *)pDevObj)->deviceId;
            break;
#endif
        ...
        case VP_DEV_886_SERIES:
        case VP_DEV_887_SERIES:
            status = VP_CALL_DEV_FUNC(GetDeviceInfo, (pDeviceInfo));
            break;
#endif
...
#if defined (VP_CC_MELT792_SERIES)
        case VP_DEV_MELT792_SERIES: {
            VpMelt792LineObjectType *pLineObj = (VpMelt792LineObjectType *)pLineInfo->pLineCtx->pLineObj;
            pLineInfo->channelId = pLineObj->channelId;
            pLineInfo->termType = pLineObj->termType;
            pLineInfo->lineId = pLineObj->lineId;
            break;
