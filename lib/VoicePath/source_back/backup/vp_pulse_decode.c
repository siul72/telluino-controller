...
#include "backup/vp_pulse_decode.h"
    ...
    uint16 timestamp)
{
    ...
    VP_HOOK(VpLineCtxType, pLineCtx, ("VpPulseDecodeStateBreak: elapsed %u.%ums, input %d", elapsed / 8, (elapsed % 8)*125, input));
    ...
    uint16 timestamp)
{
    ...
    VP_HOOK(VpLineCtxType, pLineCtx, ("VpPulseDecodeStateMake: elapsed %u.%ums, input %d", elapsed / 8, (elapsed % 8)*125, input));
